        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentByPushNotification = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailAppointmentReminders = table.Column<bool>(type: "boolean", nullable: false),
                    EmailNewAppointments = table.Column<bool>(type: "boolean", nullable: false),
                    EmailAppointmentChanges = table.Column<bool>(type: "boolean", nullable: false),
                    EmailPromotions = table.Column<bool>(type: "boolean", nullable: false),
                    Want24HourReminder = table.Column<bool>(type: "boolean", nullable: false),
                    Want48HourReminder = table.Column<bool>(type: "boolean", nullable: false),
                    WantWeekReminder = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionController = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
